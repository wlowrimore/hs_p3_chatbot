    ...
    <div className="glow w-full max-w-[30rem] p-8 border-[#64329e] border rounded-3xl">
      ...
      <section className="w-full h-[6rem] flex items-center justify-center mt-4">
        <div
          ...
          className="flex items-center justify-center gap-2 cursor-pointer button-glow max-w-[75%] py-2 px-4 bg-black text-white rounded-full opacity-80 border hover:text-[#cba9f2]"
        >
          <Image
            src={GoogleLogo}
            alt="Google"
